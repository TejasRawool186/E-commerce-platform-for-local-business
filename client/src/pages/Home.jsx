      ...
      <section className="bg-gradient-to-r from-primary-500 to-primary-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="text-center">
            ...
            B2B E-Commerce Platform for Local Businesses
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
            A digital platform designed to help local sellers and retailers connect, manage products, and grow their business.
            </p>
