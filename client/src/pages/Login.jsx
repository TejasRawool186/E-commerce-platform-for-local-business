  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Smooth redirect based on user role
        ...
        showError('❌ ' + (result.message || 'Invalid email or password. Please check your credentials and try again.'));
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="hidden lg:flex items-center justify-center bg-gray-100">
        <img
          src="./image/login.png" // Replace with your actual image path
      ...
      {/* Right Side Form */}
      <div className="flex items-center justify-center bg-background py-12 px-4 sm:px-6 lg:px-8 "style={{backgroundColor:'#ffffffff'}}>
        <div className="max-w-md w-full space-y-8">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-text-secondary">
              Or{' '}
              <Link href="/register" className="font-medium text-primary-500 hover:text-primary-700">
