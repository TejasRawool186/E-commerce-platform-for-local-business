...
import { Package, MapPin, Phone, Mail, ShoppingCart, Loader as Loader2, ArrowLeft, Plus, Minus } from 'lucide-react';
...
const ProductDetail = () => {
  ...
  const { addToCart, isInCart, getCartItem, updateQuantity: updateCartQuantity } = useCart();
  ...
  const handlePlaceOrder = () => {
    ...
    if (user.id === seller?.id) {
      toast.error('Cannot order your own product');
      return;
    }
  ...
  const handlePaymentSuccess = async (paymentData) => {
    ...
    try {
      ...
      if (paymentData.paymentType === 'advance') {
        ...
        toast.success(`Payment successful! ₹${paymentData.totalAmount.toFixed(2)} paid. Order placed successfully!`);
      }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">
            {error?.message === 'Product not found' ? 'Product Not Found' : 'Unable to Load Product'}
          </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <div className="aspect-square bg-white rounded-lg shadow-md flex items-center justify-center">
              ...
              <div className={`flex items-center justify-center w-full h-full ${product.images && product.images.length > 0 ? 'hidden' : ''}`}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-500">
                      {quantity} {product.unit} × ₹{parseFloat(product.price).toFixed(2)}
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      {productInCart ? `In Cart (${cartItem?.quantity || 0})` : 'Add to Cart'}
                    </button>

                    <button
                      onClick={handlePlaceOrder}
                      disabled={isProcessing || quantity < product.moq}
