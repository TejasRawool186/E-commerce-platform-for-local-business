          ...
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link 
                href="/about" 
                className={`text-sm font-medium transition-colors ${
                  location === '/about' ? 'text-primary-500' : 'text-text-secondary hover:text-text-primary'
                }`}
              >
                About
              </Link>
              ...
              <Link 
                href="/contact" 
                className={`text-sm font-medium transition-colors ${
                  location === '/contact' ? 'text-primary-500' : 'text-text-secondary hover:text-text-primary'
                }`}
              >
                Contact
              </Link>
            ...
            <div className="hidden md:flex items-center space-x-4">
              {/* Cart Icon - Show for retailers */}
              {isAuthenticated && user?.role === 'retailer' && (
                <Link 
                  href="/cart" 
                  className="relative p-2 text-text-secondary hover:text-primary-500 transition-colors"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/contact" className="text-sm text-text-secondary hover:text-text-primary">Contact</Link></li>
