...
export const getImageUrl = (imagePath) => {
  ...
  return `${currentServerUrl}/uploads/${imagePath}`;
};
...
export const api = {
  ...
  updateMe: (userData) => apiCall('/api/auth/me', {
    method: 'PUT',
    body: JSON.stringify(userData)
  }),
  ...
  getSalesReport: (month, year) => apiCall(`/api/seller/sales-report?month=${month}&year=${year}`),
